  ...
  return (
    <section id="product" className={layout.sectionReverse}>
      ...
      <div className={layout.sectionInfo}>
        <h2 className={styles.heading2}>Easily coontrl your <br className='sm:block hidden' /> billing & invoice</h2>
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
          some shit to complete this shit gamw ti poutana ti panagia kai to bastardo paidi tis
        </p>
